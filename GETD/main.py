...
class Experiment:
    ...
    def train_and_eval(self, args):
        ...
        self.GAN = HyperGAN(train_data_idxs, args, model, device, len(d.entities), len(d.relations), args.hidden_dim, args.hard)
        ...
        for it in range(0, self.num_iterations):
            ...
            with torch.no_grad():
                ...
                if v_mrr > best_valid_metric['mrr']:
                    ...
                    print('====Current Epoch:%d, Best Epoch:%d, test_MRR didn\'t increase for %d Epoch, best test_MRR=%f' % (
